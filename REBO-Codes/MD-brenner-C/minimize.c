...
{
  double *rr = (double *)xmalloc((3*info->num_atms + 1)*sizeof(double));
  double *g = (double *)xmalloc((3*info->num_atms + 1)*sizeof(double));
  double *wr = (double *)xmalloc((15*info->num_atms + 3)*sizeof(double));
  double eeps = 1.0e-7;
  double acc = 1.0e-20;
  double f;
  int mxfun = 1500;
